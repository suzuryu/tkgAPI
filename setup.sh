...
sudo apt-get install -y python3 python-dev python3-venv python3-dev libsqlite3-dev libsqlite3-mod-spatialite gpp gcc clang unixodbc-dev unixodbc-bin unixodbc libmecab-dev build-essential libstdc++6 libssl-dev libffi-dev libxml2-dev libxslt1-dev zlib1g-dev python-pip nginx uwsgi
